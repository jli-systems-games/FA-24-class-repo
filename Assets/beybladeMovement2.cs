...
public class beybladeMovement2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        rb.AddTorque(currentSpinSpeed, ForceMode2D.Impulse);
    }
    ...
    void Update()
    {
        ...
        //if the radius is 0 stop moving center
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("Beyblade") && stamina > 0)
        {
            ...
            rb.AddForce(-knockbackDirection * collisionKnockback, ForceMode2D.Impulse);
