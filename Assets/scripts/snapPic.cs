...
public class snapPic : MonoBehaviour
{
    ...
    public detectItem radiotarget;
    public detectItem booktarget;
    public detectItem walkmantarget;
    public detectItem diningtabletarget;
    public detectItem lamptarget;
    public detectItem cabinettarget;
    public detectItem bintarget;
    public detectItem sinktarget;
    public detectItem tablelamptarget;
    public detectItem fireextinguishertarget;
    public detectItem pianotarget;
    ...
    void Update()
    {
        if (zoomed.isZoomed == true && Input.GetKeyDown(KeyCode.Mouse0))
        {
            ...
            || artsuppliestarget.withinTarget == true || gramophonetarget.withinTarget == true
             || radiotarget.withinTarget == true || booktarget.withinTarget == true
             || walkmantarget.withinTarget == true || diningtabletarget.withinTarget == true
             || lamptarget.withinTarget == true || cabinettarget.withinTarget == true
             || bintarget.withinTarget == true || sinktarget.withinTarget == true
             || tablelamptarget.withinTarget == true || fireextinguishertarget.withinTarget == true
             || pianotarget.withinTarget == true)
            {
