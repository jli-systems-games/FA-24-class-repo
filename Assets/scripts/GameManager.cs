...
public class GameManager : MonoBehaviour
{
    ...
    private void GameOver()
    {
        ...
        StartCoroutine(MoveOpenAreaToCenter());
    ...
    private System.Collections.IEnumerator MoveOpenAreaToCenter()
    {
        RectTransform rectTransform = GameObject.Find("OpenArea").GetComponent<RectTransform>();
